...
static int gpioLed[GPIOLEDCNT] = {518,519,520,521,522,523,524,525};
static int gpioKey[GPIOKEYCNT] = {528,529,530,531,532,533,534,535};
...
static irqreturn_t sw_isr(int irq, void *unuse)
{
	int i;
	for(i=0;i<GPIOKEYCNT;i++)
	{
